...
class FichaTecnicaController extends Controller
{
    public function show(Request $request, Vehiculo $vehiculo): Response
    {
        ...
        $ultimasRevisiones = [
            'expediente' => VehiculoEspecificaciones::where('vehiculo_id', $vehiculo->placa)->max('fecha_verificacion'),
            'accesorios' => VehiculoAccesorios::where('vehiculo_id', $vehiculo->placa)->max('fecha_verificacion'),
            'piezas' => VehiculoPiezas::where('vehiculo_id', $vehiculo->placa)->max('fecha_verificacion'),
        ];
